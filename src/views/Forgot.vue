<template>
    ...
    <div class="user-box">
      <div class="user-title">
        <div class="fine-password">找回密码!</div>
      ...
      <van-form v-show="!isNext">
        ...
        >
          <template #button>
            <van-button size="small" color="#e20000" :disabled="isSend" @click="getValidCode">{{text}}</van-button>
          </template>
        </van-field>
        <div class="forgot clearfix">
          <span class="already fr" @click="goState('Login')">已有账号，立即登录</span>
        </div>

        <div class="commit-btn">
          <van-button @click="next()" round block >
            下一步
          </van-button>
        </div>
      </van-form>
      ...
      <van-form v-show="isNext">
        ...
        <div class="commit-btn">
          <van-button round block color="#a9643d" @click="commit">
            提交
          </van-button>
        </div>
        <div class="commit-btn">
